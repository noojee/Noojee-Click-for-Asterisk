			            ...
			            try
			            {
				            ...
				            else
				            {
					            ...
					            if (pattern != null && theApp.util.trim(pattern).length != 0)
					            {
						            ...
						            theApp.util.njdebug("render", "regex=" + phonePatternRegex);
						            ...
						            for ( var candidateTag = null, i = 0; (candidateTag = candidateTags.snapshotItem(i)); i++)
						            {
							            ...
							            theApp.util.njdebug("render", "examining node=" + candidateTag.nodeValue);
							            /*
							            ...
							            if (phonePatternRegex.test(candidateTag.nodeValue))
							            {
											 ...
											 */
								            theApp.util.njdebug("render", "Scanning for an editor parent for cand=" + candidateTag);
...
//									            var child = candidateTag.previousSibling;
...
//									            	candidatePosition++;
									            ...
									            theApp.util.njdebug("render.build", "candidateContents=" + candidateContents);
									            ...
									            for ( var match = null, lastLastIndex = 0; (match = phonePatternRegex.exec(candidateContents));)
									            {
													 ...
													 */
									            	theApp.util.njdebug("render.build", "match=" + match);
										            ...
										            theApp.util.njdebug("render.build", "match is good");

										            theApp.util.njdebug("render.build", "appending" + nonMatching);
										            ...
										            theApp.util.njdebug("render.build", "appending" + clickElement);
										            if (insertPosition == null)
									            ...
									            theApp.util.njdebug("render.build", "appending" + candidateContents.substring(lastLastIndex));
									            if (insertPosition == null)
